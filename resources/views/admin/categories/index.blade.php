...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button type="button" class="btn btn-sm btn-warning" data-bs-toggle="modal"
                                                    ...
                                                    onclick="populateEditCategoryModal({{ $category }}, '{{ route('admin.categories.update', $category->id) }}')">
                                                    تعديل
                                                </button>
                                                <!-- Delete Form -->
                                                <form action="{{ route('admin.categories.destroy', $category->id) }}"
                                                    ...
                                                    <button type="submit" class="btn btn-sm btn-danger"
                                                        onclick="return confirm('هل أنت متأكد من حذف هذه الفئة؟');">حذف</button>
                                                </form>
                                            </td>
                                        </tr>
                ...
                <form id="editCategoryForm" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="editCategoryNameAr" class="form-label">اسم الفئة</label>
                                <input type="text" class="form-control" id="editCategoryNameAr" name="name_ar" required>
                            </div>
                            <div class="mb-3">
                                <label for="editCategoryDescriptionAr" class="form-label">وصف الفئة</label>
                                <textarea class="form-control" id="editCategoryDescriptionAr" name="description_ar" rows="3" required></textarea>
                            </div>
                            <div class="mb-3">
                                <label for="editCategoryImage" class="form-label">الصورة</label>
                                <input class="form-control" type="file" id="editCategoryImage" name="image">
                                <img id="editCategoryImagePreview" src="" alt="Category Image" width="50"
                                    class="mt-2">
                            </div>
                        </div>
    ...
    <script>
        function populateEditCategoryModal(category, actionUrl) {
            ...
            if (category.image) {
                imagePreview.src = `/storage/${category.image}`;
